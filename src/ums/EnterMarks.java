...
public class EnterMarks extends JFrame implements ActionListener {
    ...
    JTextField tfsub1,tfsub2,tfsub3,tfsub4,tfsub5,tfmarks1,tfmarks2,tfmarks3,tfmarks4,tfmarks5;
     EnterMarks(){
        ...
        JLabel lblsem = new JLabel ("select  Sem");
        ...
        JLabel lblentersub= new JLabel ("enter subject name");
        ...
        if(ae.getSource()== submit){
            try{
                String query1="insert into subject values('"+crollno.getSelectedItem()+"','"+cbsem.getSelectedItem()+"','"+tfsub1.getText()+"','"+tfsub2.getText()+"','"+tfsub3.getText()+"','"+tfsub4.getText()+"','"+tfsub5.getText()+"')";
...
public static void main(String[]args){
        ...
        new EnterMarks();//creating class object
}
}