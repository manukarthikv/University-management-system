...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    AddTeacher(){
        ...
        JLabel lblempid=new JLabel("Employee Number");
        lblempid.setBounds(50,200,350,30);
        lblempid.setFont(new Font("serif",Font.BOLD,20));
        add(lblempid);
        
        
        labelempid=new JLabel("666"+first4);
        labelempid.setBounds(250,200,300,30);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== submit){
            ...
            try{
                String query="insert into teacher values('"+name+"','"+empid+"','"+dob+"','"+phone+"','"+email+"','"+course+"','"+branch+"')";
                Conn con=new Conn();
    ...
    public static void main(String[]args){
        new AddTeacher();//creating class object
}
}
